...
const GameBoardContent = ({Gameplay,GamePiece,animations,handleClick,score,setScore}) => {
    return(
        <motiondiv className="flex  relative flex-wrap lg:w-1/2 w-[90%] md:w-[70%] justify-around items-center gap-20 h-auto lg:min-h-[85vh] large-square md:min-h-[40vh]  min-h-[50vh]">
